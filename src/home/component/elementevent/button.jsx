...
export default function Button(properties){
    ...
    if(typeof props.onClickStyle.boxShadow==='undefined'){
        props.onClickStyle.boxShadow ='0 0 0px 7px rgba(5, 102, 233, 0.34)'
    }
    ///---------------click event -------------------
    ...
    return(
        <div
            style={{...props.style,...hover,...clickedStyle,...holdStyle}}
            onMouseEnter={()=>{onHoverEvent('enter')}}
            onMouseLeave={()=>{onHoverEvent('leave')}}
            onClick={()=>{
                    onClickedEvent();
                    if(!(typeof props.functionOnClicked==='undefined')){
                        props.functionOnclicked();
                    }
                }
            }
            onMouseDown={()=>{
